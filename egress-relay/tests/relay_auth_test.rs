use egress_relay::relay_auth::{AuthError, AuthGate, AuthPolicy, KeyRing, RelayAuthRequest};
use egress_relay::relay_protocol::{ProtocolError, RelaySigningInput};
...
impl TestRequest {
    ...
    fn sign(&self, secret: &[u8]) -> String {
        ...
        egress_relay::relay_protocol::sign_relay_request(&input, secret).unwrap()
    }
